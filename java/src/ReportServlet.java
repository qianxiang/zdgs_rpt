...
public enum  REPORTTYPE{fld,sld,jld,lyd,nbdbd,rkd};

private String pdfBuilder(String reportid, REPORTTYPE reportType) throws Exception {
	...
	String src =webPath+"/template/"+templateName;
	String dest = "";
	synchronized (dest){
		dest = "dest/"+System.currentTimeMillis() + ".pdf";
	}
	PdfFiels.manipulatePdf(src, webPath+"/"+dest,report);
	return dest;
	}
}
